...
@RestController
@RequestMapping("/api/rental-kafka")
public class RentalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RentalKafkaResource.class);
    ...
    public RentalKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
