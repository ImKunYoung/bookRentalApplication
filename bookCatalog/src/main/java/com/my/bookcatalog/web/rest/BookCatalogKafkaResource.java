...
@RestController
@RequestMapping("/api/book-catalog-kafka")
public class BookCatalogKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BookCatalogKafkaResource.class);
    ...
    public BookCatalogKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
